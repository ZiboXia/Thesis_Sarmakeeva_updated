...
%\begin{figure}[!ht]
%    \centering
%    \includegraphics[width=16cm, height = 10cm]{Images/chap3/l2_norm.png}
...
%\begin{figure}[!ht]
 %   \centering
 %   \includegraphics[width=16cm, height = 10cm]{Images/chap3/l_inf.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{/Images/chap3/nan_simulation_192000_diff_cells_number.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/chap4/landslide_1.png}
        \subcaption{0.05 sec}
    \end{minipage}%
    \hspace{0.05\textwidth}
    \begin{minipage}{.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/chap4/landslide_2.png}
        \subcaption{0.1 sec}
    \end{minipage}
    \newline
    \begin{minipage}{.4\textwidth}
